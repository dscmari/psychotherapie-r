    ...
    <div id="kostenerstattung" className={`scroll-mt-24 ${className}`}>
      ...
      <div className="max-w-4xl flex flex-col gap-4">
        <p>
          ...
          Therapieplätze vorhanden sein. Die Realität zeigt, dass der Bedarf an
          Psychotherapie höher ist als die verfügbaren Therapieplätze in
          Kassenpraxen.
        </p>
        <p>
        ...
        <p>
          Das Kostenerstattungsverfahren in der gesetzlichen Krankenkasse (GKV)
          in Deutschland bedeutet somit, dass Sie Ihre Behandlung in einer
          Privatpraxis selbst bezahlen und die Kosten nach positiv bewilligtem
          Antrag von der gesetzlichen Krankenkasse teilweise erstattet
          bekommen.{" "}
        </p>
        ...
        <p>
          ...
          benannten TherapeutInnen innerhalb eines zumutbaren Zeitraums, in der
          Regel etwa 6 Wochen bis 3 Monate, keinen Therapieplatz anbieten
          können. Falls von Ihrer Krankenkasse keine konkreten Namen von
          qualifizierten PsychotherapeutInnen genannt werden, sollten Sie selbst
          mindestens fünf approbierte PsychotherapeutInnen mit Kassenzulassung
          („Kassensitz“) kontaktieren und schriftlich dokumentieren, dass dort
          aktuell kein Behandlungsplatz verfügbar ist. Die Dokumentation umfasst
          insbesondere Datum und Uhrzeit der Kontaktaufnahme sowie das jeweilige
          Ergebnis. Zum Beispiel: "kein freier Therapieplatz", "keine Aufnahme
          möglich", "Wartezeit über einem zumutbaren Rahmen".
        </p>
        <div className="flex md:items-center gap-2 ">
        ...
        <p>
          Diese Unterlagen reichen Sie anschließend bei Ihrer Krankenkasse ein,
          zusammen mit einer ärztlichen Bescheinigung über die dringliche
          Notwendigkeit einer Psychotherapie, durch eine/n Hausärztin/Hausarzt
          oder eine Fachärztin/Facharzt für Psychotherapie. Ergänzend weisen Sie
          darauf hin, dass bei einem privat niedergelassenen approbierten
        ...
        <div className="flex md:items-center gap-2 ">
          <ZoomIn size={32} className="shrink-0 text-sage-dark font-semibild" />
          <span className="font-semibold text-xl !text-sage-dark">
        ...
        <p>
          Wird Ihr Antrag genehmigt, übernimmt Ihre Krankenkasse die Kosten für
          die psychotherapeutische Behandlung. Die Abrechnung erfolgt in der
          Regel direkt zwischen Ihnen und der Krankenkasse: Sie erhalten die
          Rechnung für die jeweilige Sitzung und reichen diese anschließend zur
          Erstattung ein.
        </p>
        <p>
