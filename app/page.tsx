...
export default function Home() {
  return (
    <div>
      ...
      <section className="sm:px-16 xl:px-32 pt-24 lg:pt-48  flex flex-col-reverse gap-12 xl:flex-row xl:items-center xl:gap-24 xl:justify-center">
      ...
      <section className="sm:px-16 xl:px-32 pt-24 lg:pt-32 xl:pt-48  flex flex-col gap-12 lg:flex lg:flex-row lg:gap-24 lg:justify-center">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                während der Behandlung, in der Nachsorge oder in einer
                palliativen Behandlungssituation.
              </p>
            </div>
          </div>
          <div className="hidden lg:flex flex-col lg:flex lg:flex-row items-center gap-4 mt-4">
            <ContactBtn className="w-full lg:w-44 " />
            <TopicBtn text={"Psychoonkologie"} path={"/#/"} />
          </div>
        </div>
        <div className="flex-1 px-4 sm:px-0 flex flex-col justify-between">
          <div>
            <h2 className="">
            ...
            <div className="flex flex-col gap-4">
              <p>
                ...
                unterstütze ich Sie bei psychosomatischen Beschwerden,
                chronischen Schmerzen und Erschöpfung.
              </p>
              <p>
                Darüber hinaus begleite ich Sie einfühlsam bei der Bewältigung
                von akutem Stress, Ängsten, persönlichen Lebenskrisen und
                emotionaler Überlastung, um gemeinsam neue Perspektiven zu
                entwickeln.
              </p>
            </div>
          </div>
          <div className="flex flex-col lg:flex-row items-center gap-4 mt-12 lg:mt-4">
            <ContactBtn className="w-full lg:w-44 " />
            <TopicBtn text={"Psychoonkologie"} path={"/#/"} />
          </div>
        </div>
      </section>
      <section className="sm:px-16 xl:px-32 pt-24 lg:pt-32 xl:pt-48  flex flex-col-reverse gap-12 lg:flex-row items-center lg:gap-24 xl:justify-center">
