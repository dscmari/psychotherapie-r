...
import { CircleSmall, MessageCircle, SendHorizontal } from "lucide-react";
      ...
      <section className="pt-4 md:pt-16 lg:pt-32 md:px-8 lg:px-16 xl:px-32">
        <div className="flex flex-col-reverse md:flex-row md:gap-8 lg:gap-16">
          <div className="flex-1 -mt-40 sm:-mt-60 md:mt-0 bg-stone-light dark:bg-darkblue px-4 md:px-0">
            <p className="md:hidden sm:ml-8 text-sm font-light dark:text-stone-light pt-2">
              Anne Julia Röhl - Psychotherapeutin
            </p>
            <h1 className="!text-sage-brown dark:!text-stone-light pt-8">
